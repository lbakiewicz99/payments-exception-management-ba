...
| reporting_snapshot_date  | Field name                   | Business name                | Description                                                                    | Data type             | Required?          | Source                           | Example                       | Related requirement |
|--------------------------|------------------------------|------------------------------|--------------------------------------------------------------------------------|-----------------------|--------------------|----------------------------------|-------------------------------|---------------------|
| 2025-02-14               | reportable_status            | Reportable Status            | Simplified status grouping for reports                                         | Text                  | Could Have         | Calculated                       | Open                          | RR-001              |
| 2025-02-14               | open_case_flag               | Open Case Flag               | Indicates whether the case is currently open                                   | Boolean               | Should Have        | Calculated                       | Yes                           | RR-001              |
| 2025-02-14               | unassigned case_flag         | Unassigned Case Flag         | Indicates whether the case has no assigned owner                               | Boolean               | Should Have        | Calculated                       | No                            | CR-006              |
| 2025-02-14               | management_review_flag       | Management Review Flag       | Indicates whether the case should appear in management review                  | Boolean               | Should Have        | Calculated                       | Yes                           | CR-003              |
| 2025-02-14               | control_exception_flag       | Control Exception Flag       | Indicates whether the case represents a control-relevant exception             | Boolean               | Could Have         | User selected/calculated         | Yes                           | CR-007              |
| 2025-02-14               | audit_history_available_flag | Audit History Available Flag | Indicates whether status, owner, priority, and notes history is retained       | Boolean               | Should Have        | Workflow generated               | Yes                           | NFR-003             |
